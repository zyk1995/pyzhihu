...
class MasterThread(Thread):
    ...
    def log(self):
        ...
        print("并发：\033[30;47m%.2f\033[0m请求/秒" % (
                (self.count['failed_count'] + self.count['success_count']) / interval))
...
class WorkerThread(Thread):
    ...
    def run(self):
        while True:
            ...
            print('将响应信息放入响应队列 %s' % responseitem['user_url_token'])
