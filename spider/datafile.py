...
class DataFile(Singleton):
    ...
    def loadusercrawled(self):
        ...
        csvfilelist = self.__getcsvfilelist()
...
if __name__ == '__main__':
    df = DataFile()
    crawledlist = df.loadusercrawled()
    crawledset = set(crawledlist)
    print(crawledlist)

    print(df.loaduseruncrawled(crawledlist))